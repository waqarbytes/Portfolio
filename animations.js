...
gsap.to('.about-content', {
    opacity: 1,
    duration: 0.1,
    scrollTrigger: { trigger: '.about-content', start: 'top 90%' }
});
...
aboutTL
    ...
    .from('.about-text-col .section-label', {
        opacity: 0,
        y: 20,
        duration: 0.5,
        ease: 'power2.out',
    ...
    .from('.about-cta .btn-primary, .about-cta .btn-outline', {
        opacity: 0,
        y: 20,
        duration: 0.6,
        stagger: 0.15,
...
gsap.to('.timeline', {
    opacity: 1,
    duration: 0.1,
    scrollTrigger: { trigger: '.timeline', start: 'top 90%' }
});
...
document.querySelectorAll('.project-card').forEach((card, i) => {
    ...
    // Number count-up for project number
...
gsap.to('.tech-grid', {
    opacity: 1,
    duration: 0.1,
    scrollTrigger: { trigger: '.tech-grid', start: 'top 90%' }
});
...
gsap.from('.tech-tile', {
    ...
    ease: 'back.out(1.4)',
    scrollTrigger: { trigger: '.tech-grid', start: 'top 70%', once: true }
});

/* ============================================================
   11. FOOTER / CONTACT — SCROLL REVEAL
   ============================================================ */
gsap.to('.footer-form-section', {
    opacity: 1,
    duration: 0.1,
    scrollTrigger: { trigger: '.footer-form-section', start: 'top 90%' }
});

gsap.from('.footer-form-section', {
    opacity: 0,
    y: 60,
    duration: 1,
    ease: 'power3.out',
    scrollTrigger: { trigger: '.footer-form-section', start: 'top 75%', once: true }
});
